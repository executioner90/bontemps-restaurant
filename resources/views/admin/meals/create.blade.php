                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10 p-2">
                    <form method="post" action="{{ route('admin.meals.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <select id="kind" name="kind" class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('kind') border-red-400 @enderror">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <select id="products" name="products[]" class="form-multiselect block w-full mt-1 @error('products') border-red-400 @enderror" multiple>
